...
/**
 * IndividualCoachingSlides — viewer slides pour la trame coaching individuel
 * (PR3.8 follow-up).
 *
 * Réutilise la structure `Kit` partagée et `buildSlidesFromKit`. Plus simple
 * que `TeamActivationSlides` : pas d'intégration Gamma (V1), juste affichage
 * + copier + télécharger .md. Pattern overlay/panel identique.
 */
export function IndividualCoachingSlides({ open, onClose, kit }: Props) {
