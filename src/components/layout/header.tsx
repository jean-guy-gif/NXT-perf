...
const pageTitles: Record<string, string> = {
  ...
  // PR3.8.1 — refonte Manager
  "/manager/diagnostic": "Mon diagnostic",
  "/manager/ameliorer": "Faire progresser mon équipe",
  "/manager/progression": "Notre progression",
  "/manager/comparaison": "Notre comparaison",
  "/manager/formation": "Ma formation",
  // legacy (conservés temporairement le temps des 308 redirect)
